...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("WEB_FinagilDataSet"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class WEB_FinagilDataSet
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As WEB_FinagilDataSet = CType(MyBase.Clone,WEB_FinagilDataSet)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "WEB_FinagilDataSet"
        Me.Prefix = ""
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As WEB_FinagilDataSet = New WEB_FinagilDataSet()
    ...
    Partial Public Class WEB_FacturasXMLDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Function FindById_factura(ByVal Id_factura As Decimal) As WEB_FacturasXMLRow
            Return CType(Me.Rows.Find(New Object() {Id_factura}),WEB_FacturasXMLRow)
        End Function
...
Namespace WEB_FinagilDataSetTableAdapters
    ...
    Partial Public Class WEB_FacturasXMLTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            tableMapping.ColumnMappings.Add("Id_facura", "Id_factura")
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.CompPagosFilialesV.My.MySettings.Default.WEB_FinagilConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT Estatus, Factura, FechaFactura, FechaPagoFinagil, FechaVencimiento, Folio,"& _ 
                " Id_Lote, Id_factura, ImporteAnticipo, ImporteFactura, MPago, Moneda, Procesado,"& _ 
                " RFC, Serie, TCambio, UUID FROM WEB_FacturasXML WHERE (Serie = @Serie) AND (Foli"& _ 
                "o = @Folio)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Serie", Global.System.Data.SqlDbType.VarChar, 10, Global.System.Data.ParameterDirection.Input, 0, 0, "Serie", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Folio", Global.System.Data.SqlDbType.[Decimal], 9, Global.System.Data.ParameterDirection.Input, 18, 0, "Folio", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(2) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(2).Connection = Me.Connection
            Me._commandCollection(2).CommandText = "SELECT        Estatus, Factura, FechaFactura, FechaPagoFinagil, FechaVencimiento,"& _ 
                " Folio, Id_Lote, Id_factura, ImporteAnticipo, ImporteFactura, MPago, Moneda, Pro"& _ 
                "cesado, RFC, Serie, TCambio, UUID"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            WEB_FacturasXML"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE       "& _ 
                " (Folio = @Folio) AND (RFC = @RFC)"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(2).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Folio", Global.System.Data.SqlDbType.[Decimal], 9, Global.System.Data.ParameterDirection.Input, 18, 0, "Folio", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As WEB_FinagilDataSet.WEB_FacturasXMLDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As WEB_FinagilDataSet.WEB_FacturasXMLDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As WEB_FinagilDataSet.WEB_FacturasXMLDataTable = New WEB_FinagilDataSet.WEB_FacturasXMLDataTable()
        ...
        Public Overloads Overridable Function Obt_CFDI_FillBy(ByVal dataTable As WEB_FinagilDataSet.WEB_FacturasXMLDataTable, ByVal Serie As String, ByVal Folio As Global.System.Nullable(Of Decimal)) As Integer
            ...
            If (Folio.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(1).Value = CType(Folio.Value,Decimal)
            Else
        ...
        Public Overloads Overridable Function Obt_CFDI_GetDataBy(ByVal Serie As String, ByVal Folio As Global.System.Nullable(Of Decimal)) As WEB_FinagilDataSet.WEB_FacturasXMLDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (Serie Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function Obt_CFDI_SoloFolio_FillBy(ByVal dataTable As WEB_FinagilDataSet.WEB_FacturasXMLDataTable, ByVal Folio As Global.System.Nullable(Of Decimal), ByVal RFC As String) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(2)
            If (Folio.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(Folio.Value,Decimal)
            Else
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function Obt_CFDI_SoloFolio_GetDataBy(ByVal Folio As Global.System.Nullable(Of Decimal), ByVal RFC As String) As WEB_FinagilDataSet.WEB_FacturasXMLDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(2)
            If (Folio.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(Folio.Value,Decimal)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As WEB_FinagilDataSet.WEB_FacturasXMLDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As WEB_FinagilDataSet) As Integer
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As WEB_FinagilDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As WEB_FinagilDataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._wEB_FacturasXMLTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As WEB_FinagilDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._wEB_FacturasXMLTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As WEB_FinagilDataSet) As Integer
