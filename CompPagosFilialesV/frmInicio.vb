        ...
        For i = 0 To dgvComplementos.Rows.Count - 1
            ...
            ElseIf dgvComplementos.Item("RFCDataGridViewTextBoxColumn", i).Value = "GTC980421R4A" Or dgvComplementos.Item("RFCDataGridViewTextBoxColumn", i).Value = "DME061031H27" Or dgvComplementos.Item("RFCDataGridViewTextBoxColumn", i).Value = "DIM061230LN8" Then
                ...
                If Me.dgvComplementos.Item("ProcesadoDataGridViewCheckBoxColumn", i).Value = True Then
                    ...
                    rowCFD_CPAGO._9_DetalleAux_Misc07 = "PPD" 'validaNull(leeXML(rowsD4.CFDOriginal, "MetodoPago"))
                    ...
                    For Each rowsD3 In dsComplemento.Vw_ChequesDetalle.Rows()
                        ...
                        For Each rowsD4 In dsWeb_Finagil.WEB_FacturasXML.Rows
                            ...
                            If rowCFD_CPAGO._7_DetalleAux_Misc05 = "MXN" Then
                                rowCFD_CPAGO._8_DetalleAux_Misc06 = ""
                            Else
                                rowCFD_CPAGO._8_DetalleAux_Misc06 = rowsD4.TCambio 'validaNull(leeXML(rowsD4.CFDOriginal, "TipoCambio"))
                            End If

                            rowCFD_CPAGO._9_DetalleAux_Misc07 = rowsD4.MPago 'validaNull(leeXML(rowsD4.CFDOriginal, "MetodoPago"))
